...
class StaffSeeder extends BaseSeeder
{
    ...
    public function runFake() {
        ...
        $staffs = [
            ...
            [ 'dept_id'=>'003', 'name'=>'이빅토르', 'email'=>'viktor@aerolink.co.kr' ],
            [ 'dept_id'=>'004', 'name'=>'최범규', 'email'=>'bgchoi@aerolink.co.kr' ],
            [ 'dept_id'=>'004', 'name'=>'정선미', 'email'=>'smjung@aerolink.co.kr' ],
            [ 'dept_id'=>'004', 'name'=>'차수연', 'email'=>'sycha@aerolink.co.kr' ],
            [ 'dept_id'=>'004', 'name'=>'강희선', 'email'=>'hskang@aerolink.co.kr' ],
            [ 'dept_id'=>'004', 'name'=>'마리아', 'email'=>'miria@aerolink.co.kr' ],
            [ 'dept_id'=>'004', 'name'=>'안유빈', 'email'=>'ubahn@aerolink.co.kr' ],
            [ 'dept_id'=>'005', 'name'=>'김대욱', 'email'=>'dokim@aerolink.co.kr' ],
            [ 'dept_id'=>'005', 'name'=>'주용훈', 'email'=>'yhjoo@aerolink.co.kr' ],
            [ 'dept_id'=>'005', 'name'=>'손혜승', 'email'=>'hsson@aerolink.co.kr' ],
            [ 'dept_id'=>'006', 'name'=>'김월래', 'email'=>'ilkim@aerolink.co.kr' ],
            [ 'dept_id'=>'006', 'name'=>'박재완', 'email'=>'jwpark@aerolink.co.kr' ],
            [ 'dept_id'=>'006', 'name'=>'허성수', 'email'=>'ssheo@aerolink.co.kr' ],
            [ 'dept_id'=>'006', 'name'=>'윤장원', 'email'=>'jwyoon@aerolink.co.kr' ],
            [ 'dept_id'=>'006', 'name'=>'장기성', 'email'=>'gschang@aerolink.co.kr' ],
            [ 'dept_id'=>'006', 'name'=>'임재권', 'email'=>'jglim@aerolink.co.kr' ],
            [ 'dept_id'=>'006', 'name'=>'김원익', 'email'=>'wikim@aerolink.co.kr' ],
            [ 'dept_id'=>'006', 'name'=>'류은혁', 'email'=>'yhryu@aerolink.co.kr' ],
            ...
            [ 'dept_id'=>'007', 'name'=>'권순남', 'email'=>'snkwon@aerolink.co.kr' ],
            ...
            [ 'dept_id'=>'008', 'name'=>'홍장표', 'email'=>'jphong@aerolink.co.kr' ],
        ];
